...
class Phase3
{
	private:
		...
		TH1D* rbn_sc_3sub_Type1[nSample+1][NA][NV][NP];
		TH1D* rbn_sc_3sub_Type2[nSample+1][NA][NV][NP];
		TH1D* rbn_nsc_3sub_Type1[nSample+1][NA][NV][NP];
		TH1D* rbn_nsc_3sub_Type2[nSample+1][NA][NV][NP];
		...
		TGraphErrors* sc_3sub_Type1[NA][NV][NP];
		TGraphErrors* sc_3sub_Type2[NA][NV][NP];
		TGraphErrors* nsc_3sub_Type1[NA][NV][NP];
		TGraphErrors* nsc_3sub_Type2[NA][NV][NP];
		TGraphErrors* ac_3sub[NV][NP];
		TGraphErrors* nac_3sub[NV][NP];

		void cal_sts(vector<TH1D*>, TH1D*, TGraphErrors*&, const char*, int iA, int iV, int iP);
