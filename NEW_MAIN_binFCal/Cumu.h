...
class Cumu
{
	private:
		...
		TH1D* ori_sc_3sub_Type1[NA][NV][NP];
		TH1D* ori_sc_3sub_Type2[NA][NV][NP];
		TH1D* raw_sc_3sub_Type1[NA][NV][NP];
		TH1D* raw_sc_3sub_Type2[NA][NV][NP];
		TH1D* rbn_sc_3sub_Type1[NA][NV][NP];
		TH1D* rbn_sc_3sub_Type2[NA][NV][NP];
		TH1D* raw_nsc_3sub_Type1[NA][NV][NP];
		TH1D* raw_nsc_3sub_Type2[NA][NV][NP];
		TH1D* rbn_nsc_3sub_Type1[NA][NV][NP];
		TH1D* rbn_nsc_3sub_Type2[NA][NV][NP];
