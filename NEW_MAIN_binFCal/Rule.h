...
const double maxBin = 5; // maximum centrality
const unsigned int nRebin[5] = {100, 50, 25, 10, 5}; // number of bins for final results
...
const unsigned int NP = 4; // number of pT cuts for differential particles
const double minPt[NP] = {0.5, 1.0, 1.5, 2.0}; // minimum pT for reference particles
const double maxPt[NP] = {5.0, 5.0, 5.0, 5.0}; // maximum pT for reference particles
const unsigned int NW = 7; // power of weights for Q-cumulant calcualtion: 0 to 6
const unsigned int NA = 6; // number of permutation for 3-subevent
