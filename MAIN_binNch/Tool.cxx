...
Tool::Tool(int runNum)
{
	...
	TFile* fInEff = new TFile("../../../MAIN_binCent/INPUT/trkEff.root","READ");
	...
	TFile* fInTrig = new TFile("../../../MAIN_binCent/INPUT/trigWeight.root","READ");
	...
	TFile* fInCvt = new TFile("../../../MAIN_binCent/INPUT/hist_cvt.root","READ");
